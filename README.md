...
|---|---|---|
| Claude Code in VS Code | companion extension | done at 0.4.6; tested live; not published yet |
...
| | |
|---|---|
| [docs/decisions.md](docs/decisions.md) | thirty-one sections: every rule and fix that was tried, measured and rejected, including the two that crashed and the one that was too slow |
